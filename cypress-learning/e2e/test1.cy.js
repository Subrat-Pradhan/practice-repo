describe("Recording 12/25/2025 at 3:39:45 PM", () => {
  it("tests Recording 12/25/2025 at 3:39:45 PM", () => {
    ...
    cy.get("#ui-id-3", { timeout: 10000 }).should("be.visible").click(); // Added timeout for search suggestion
    cy.location("href").should("eq", "https://demowebshop.tricentis.com/141-inch-laptop");
    cy.get("#add-to-cart-button-31", { timeout: 10000 }).should("be.visible").click();
